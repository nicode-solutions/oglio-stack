...
export default function FilesPage() {
    ...
    return (
        ...
        >
            <div className='m-4 flex flex-col gap-8 grow items-stretch'>
                ...
                {documents && (
                    <div className="grid grid-cols-4 gap-4">
                        {documents.map((document) => (
                            ...
                            <div
                                key={document.id}
                                className="flex flex-col gap-2 justify-center items-center border rounded-md p-4 text-center overflow-hidden cursor-pointer hover:bg-slate-100"
                                onClick={async () => {
